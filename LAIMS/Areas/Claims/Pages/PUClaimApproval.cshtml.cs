...
namespace LAIMS.Areas.Claims.Pages
{
 [Authorize(Roles = "Claims Approver")]
    public class PUClaimApprovalModel : PageModel
    {
        ...
        public PUClaimApprovalModel(UserManager<ApplicationUser> userManager, IPolicyRepository policyRepository,
        ...
        public IActionResult OnPost()
        {
			...
			//{
				using (TransactionScope TS = new TransactionScope())
				{
					...
					if (StatusID == 3300)// Exgratia requested
					{
					...
					if (StatusID == 3250) //Claim Approved as is
					{
						string PolicyNo = _policyClaimRepository.GetPolicyNo(RequestID);
						int claimID = _policyClaimRepository.GetClaimIDByRequestID(RequestID);
