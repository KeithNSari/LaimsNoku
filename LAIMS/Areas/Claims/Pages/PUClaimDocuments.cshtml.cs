...
namespace LAIMS.Areas.Claims.Pages
{
    ...
    public class PUClaimDocumentsModel : PageModel
    {
        ...
        public PUClaimDocumentsModel(UserManager<ApplicationUser> userManager, IMediaUploadRepository mediaUploadRepository,
