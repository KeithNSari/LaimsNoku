...
namespace LAIMS.Areas.PolicyServicing.Pages.Policies
{
   // [Authorize(Roles = "Policy Servicing Approver")]
    public class ReviewsModel : PageModel
    {
        ...
        public ReviewsModel(UserManager<ApplicationUser> userManager, IPolicyRepository policyRepository, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public void OnGet()
        {
            PoliciesDT = _policyRepository.GetPoliciesAwaitingBeneficiaryUpdatesApproval();
