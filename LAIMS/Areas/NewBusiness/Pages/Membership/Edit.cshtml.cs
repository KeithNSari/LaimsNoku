    ...
    public class EditModel : PageModel
    {
        ...
        public IActionResult OnPost(Guid id)
        {
            try
            {
                ...
                Member OGMember =_memberRepository.GetMemberById(id);
                ...
                bool IDUpdate = false;
                if ((OGMember.NationalID != Member.NationalID) || (OGMember.BirthCertificate != Member.BirthCertificate) || (OGMember.Passport != Member.Passport))
                {
                    IDUpdate = true;
                    _memberRepository.SetConfirmation(id, 0);
                }
