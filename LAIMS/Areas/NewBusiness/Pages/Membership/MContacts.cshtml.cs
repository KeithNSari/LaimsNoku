...
{
    public class MContactsModel : PageModel
    {
        ...
        public MContactsModel(UserManager<ApplicationUser> userManager, IMemberRepository memberRepository, IContactTypeRepository contactTypeRepository, IMemberContactRepository memberContactRepository, ICountryRepository countryRepository, ICityRepository cityRepository)
        {
