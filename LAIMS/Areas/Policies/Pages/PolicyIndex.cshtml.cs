...
{
    [Authorize]
    public class PolicyIndexModel : PageModel
    {
        ...
        public PolicyIndexModel(UserManager<ApplicationUser> userManager, IPolicyRepository policyRepository, IWebHostEnvironment webHostEnvironment)
        {
