...
namespace LAIMS.Areas.Policies.Pages
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        public DataTable SettlementsDT;
        ...
        public IActionResult OnGet(Guid id, Guid policyTypeid, Guid policyid)
        {
            ...
            AllocationSuspenseDT = _billedPremiumRepository.GetAllocationSuspenseEntries(policyid);
            PolicySuspenseDT = _suspenseProcessing.GetPolicySuspenseData(policyid);
            UnpaidDT = _billedPremiumRepository.GetUnPaid(policyid);
            MessagesDT = _billingMessageRepository.GetBillingMessages(policyid);
            ClaimsDT = _policyClaimRepository.GetByPolicyID(policyid);
            SettlementsDT = _policyClaimRepository.GetSettlements(policyid);
            return Page();
        }
