...
namespace LAIMS.Areas.UTools.Pages.Rates
{
    ...
    public class CoverLevelsIndexModel : PageModel
    {
        ...
        public CoverLevelsIndexModel(UserManager<ApplicationUser> userManager, IWebHostEnvironment environment,
        ...
        public void OnGet()
        {
            try
            {
                ...
                RatesDT = _paymentRepository.GetLatestCoverLevels();
            }
            catch (Exception ex)
            {
            ...
            try
            {
                if (Upload != null)
                {
                    ...
                    using (TransactionScope TS = new TransactionScope())
                    {
                        ...
                        _paymentRepository.UploadRates(fileContents.DataDT, mediaUploadID, EffectiveDate, "Cover Levels", AddedBy);
                        TS.Complete();
                    }
                }
